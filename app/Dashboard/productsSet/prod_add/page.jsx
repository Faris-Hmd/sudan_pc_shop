  ...
  async function handleProductImgsSubmit(e) {
    ...
    const uploadAndSubmit = async () => {
      ...
      try {
        ...
        // 3. Cleanup (Only runs if no redirect happened)
        setImgs([]);
        formElement.reset();
                ...
                className={`
                  ...
                  ${
                    pending
                      ...
                      : "bg-indigo-50 text-blue-600 hover:bg-indigo-100 border border-indigo-200"
                  }
                `}
                htmlFor="imgsInput"
              >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                disabled={pending}
                placeholder="0.00"
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none"
              />
            </div>
