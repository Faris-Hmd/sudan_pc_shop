...
function Dropdown({ id }: any) {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="rounded-2xl shadow-xl dark:bg-slate-900 dark:border-slate-800 min-w-[140px] p-1.5 animation-in fade-in zoom-in-95 duration-200">
