...
export function ModeToggle() {
  ...
  return (
    <button
      ...
      className="relative w-10 h-10 flex items-center justify-center rounded-xl bg-muted/20 text-muted-foreground hover:text-primary border border-border transition-all active:scale-95 group overflow-hidden"
